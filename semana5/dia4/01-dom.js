...
input2[0].style.backgroundColor= "green";
console.log("query",input2)

// accedemos al input del nombre

const input_name = document.getElementsByTagName('input')[1];
input_name.style.backgroundColor= "blue";
...
const last_input = document.getElementsByTagName('input')[4];
last_input.style.backgroundColor= "brown";
last_input.style.color= "white";
console.log("Ultimo input: ",last_input)